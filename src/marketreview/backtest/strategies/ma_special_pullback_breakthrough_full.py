"""长期特殊均线突破拉回 完整版 — MA止损 + 战法卖出 + 时间止损 + 三级止盈."""
...
@register_strategy("ma_special_pullback_breakthrough_full")
class MASpecialPullbackBreakthroughFullStrategy(BaseStrategy):
