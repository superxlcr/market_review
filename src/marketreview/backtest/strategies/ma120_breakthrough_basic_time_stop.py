...
@register_strategy("ma120_breakthrough_basic_time_stop")
class MA120BreakthroughBasicTimeStopStrategy(BaseStrategy):
    ...
    @property
    def name(self) -> str:
        return "MA120突破+拉回+时间止损(无MA120止损)"
