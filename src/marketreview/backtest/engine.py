...
class BacktestEngine:
    ...
    def __init__(self, dp, pool: PoolConfig, strategy_cfg: StrategyConfig):
        ...
        from .strategies import ma_breakthrough, ma60_breakthrough, ma120_breakthrough, ma55_breakthrough, ma144_breakthrough, ma55_volume, ma60_volume, half_retrace, half_retrace_simple, composite  # noqa: F401
