...
# Industry label resolution — delegates to the shared split config.
# The recursive rule: default → L1, SPLIT_L1 → L2, SPLIT_L2 → L3.
# See marketreview.tools.industry for the configuration.

from marketreview.tools.industry import (
    resolve_industry_label as pick_industry_label,
    resolve_industry_code as pick_industry_code,
)
...
def build_index_contribution(
    ...
    def _attach_name_industry(item: dict) -> dict:
        ...
        return {
            ...
            "industry_code": pick_industry_code(l1_code, l1_name,
                                                l2_code, l2_name,
                                                l3_code, l3_name),
            "weight": item["weight"],
